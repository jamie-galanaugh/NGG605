...
%storenames = {'470B' '405B' 'Ms1/' 'Ms1\' 'Ms2/' 'Ms2\' };
    ...
    filepath= 'C:\Users\edgar\Desktop\dopaminesensor\5_1_and_6_1-210608-155017\5_1_and_6_1';
...
for i = 1:nTTL1
    ...
    PsthArray_TTL1(i,:) = processPhotDataRow_normDat(normDat_DB_sub, thisIndex, nTsPrev, nTsPost);
end
...
for i = 1:nTTL2
    thisTime = TTL2(i);
    thisIndex = round((thisTime*samplingRate))+1;
    PsthArray_TTL2(i,:) = processPhotDataRow_normDat(normDat_DB_sub, thisIndex, nTsPrev, nTsPost);
end
...
legend ([h1 h2 h3 h4], 'TTL1', 'TTL2', 'TTL3', 'TTL4', 'orientation', 'vertical', 'Location', 'SouthWest');
legend BOXOFF;
